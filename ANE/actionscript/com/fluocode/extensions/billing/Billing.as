package com.fluocode.extensions.billing
{
	...
	public class Billing
	{
		...
		/**
		 * Optional dependency used by some AIR packaging pipelines (OverrideAir).
		 * If present, it may patch the extension context at runtime.
		 */
		...
		public function Billing(androidInAppIDs:Array, androidSubsIDs:Array, allIosIDs:Array, onResult:Function)
		{
			...
			try
			{
				...
				if (OverrideClass && OverrideClass["applyToAneLab"] != null)
				{
			...
			try
			{
				if (OverrideClass && OverrideClass["applyToOverrides"] != null)
				{
